...
class Internship extends StatefulWidget {
  int sem;
  String skill;
  Internship({required this.skill, required this.sem});
  @override
  _CareerPg createState() => _CareerPg();
}

class _CareerPg extends State<Internship> {
  unitList(Height) {
    print(widget.sem);
    print(widget.skill);
    return StreamBuilder<DocumentSnapshot>(
        stream: FirebaseFirestore.instance
            ...
            .doc('Select tech ' + widget.sem.toString())
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        Image.asset('assets/Internship.jpg'),
                        Container(
